...
- **Deal review meetings** - Structured analysis for pipeline reviews
- **Sales coaching** - Evidence-based feedback on rep performance
- **Forecast accuracy** - Objective deal health assessment
- **Win/loss analysis** - Pattern identification across multiple calls
...
**Duration**: 32 minutes
**Talk-time ratio**: Rep 45% / Prospect 55%
**Sales stage**: Discovery/Qualification
**Sentiment**: Positive, engaged, asking detailed questions
